...
Pattern4x6::Pattern4x6(QWidget *parent) : QWidget(parent),mGap(30)
{
...
void Pattern4x6::setGap(int gap)
{
    mGap = gap;
}

int Pattern4x6::gap() const
{
    return mGap;
}

void Pattern4x6::mousePressEvent(QMouseEvent *event)
{
    mIsZoom = false;
    auto pos = event->pos();
...
void Pattern4x6::wheelEvent(QWheelEvent *event)
{
...
void Pattern4x6::paintEvent(QPaintEvent *event)
{
...
void Pattern4x6::setSelectedRect(int row,int col, bool isSelected)
{
...
bool Pattern4x6::isSelected(int row,int col) const
{
...
void Pattern4x6::setZoom(double zoom)
{
    mZoom = zoom;
}

double Pattern4x6::zoom() const
{
    return mZoom;
}
