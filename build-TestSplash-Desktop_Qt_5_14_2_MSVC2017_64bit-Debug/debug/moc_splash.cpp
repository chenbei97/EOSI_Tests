...
QT_MOC_LITERAL(3, 12, 14) // "updateProgress"

    },
    "Splash\0end\0\0updateProgress"
};
...
void Splash::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Splash::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Splash::end)) {
                *result = 0;
                return;
            }
        }
