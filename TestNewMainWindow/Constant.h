...
#define SocketWaitTime 3000 // 套接字连接阻塞的时间
...
#define TableViewBorderHighlightColor (QColor(Qt::red)) // 统一的单元格边框高亮颜色
    ...
    // 登录窗口设置
    #define LoginButtonHeight 200 // button的高度也是整体行布局的高度
    ...
    #define RunRightPanelMinWidth 300 // 当前实验显示信息面板的最小宽度
...
// 1080尺寸 1920/2560=0.75 1080/1600=0.675
    ...
    #define PreviewPicFixedSizeV1 (QSize(320,320)) // 细胞增殖-预览界面图片尺寸过大挤压了 "预览"和"运行"按钮小一些
...
// 1280/2560=0.5 800/1600=0.5
    ...
    #define MainToolButtonMinWidth 180 // 当前,查询和新建实验3个按钮降低默认最小宽度
    ...
    #define PreviewPicFixedSizeV1 (QSize(250,250)) // 细胞增殖-预览界面图片尺寸过大挤压了 "预览"和"运行"按钮小一些
    #define PreviewPicFixedSizeV2 (QSize(450,450)) // 细胞增值-运行界面 图片尺寸用V1有点小
