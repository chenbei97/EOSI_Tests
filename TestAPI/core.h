...
#define SPLASH_LOAD_TIME 5000 // splash启动的时间 , /100是每次设置进度条的延时时间
#define MAIN_SPLASH_RELATIVE_TIME 250 // main和splash启动的最大相对时间差 500= 90%~100%之间
#define MAIN_LOAD_TIME (5000-QRandomGenerator::global()->bounded(1,MAIN_SPLASH_RELATIVE_TIME+1)) // 主窗口定时启动的延迟时间
